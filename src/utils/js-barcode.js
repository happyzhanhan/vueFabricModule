...
export default {
    install(Vue, options) {
        Vue.prototype.barcode = function (element, datas, type, settings) {
            console.warn(element, datas, type, settings)
            var $this = $(element);
            var digit = "",
                hri = "",
                code = "",
            ...
            console.warn(digit)
            console.log(settings.output.charAt(0).toUpperCase() + settings.output.substr(1) + (b2d ? '2D' : ''))
