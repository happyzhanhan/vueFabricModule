<template>
  <div class="copy-ps">
      <div class="ps-head"  id="capture">
        ...
        <div class="psh-button" @click="save">
          <b >点击保存数据</b>
        </div>

        <div class="psh-button" @click="loadjson">
          <b >加载json</b>
        </div>
      </div>
  ...
  <!--            </div>-->
  <!-- /img/group1/M00/01/30/rBMAA2WnnLmAaeZHAA1Rx0gWfdg718.png -->
...
export default {
  ...
  methods: {
    ...
    async draw (name) {
      ...
      let messages = [
        '0我的好时机安居房快捷键萨克副教授看|了附近时空大姐夫开始打积分卡仕达及啊看放假撒加分撒酒疯|打开积分看电视剧阿发空间的萨克福建省啦',
        'I am Chiniese',
        '1我的好时机安居房快捷键萨克副教授看了附近时空大姐夫开始打积分卡仕达及啊看放假撒加分撒酒疯|打开积分看电视剧阿发空间的萨克福建省啦',
        '2怒发冲冠，凭栏处、潇潇雨歇。抬望眼，仰天长啸，壮怀激烈。三十功名尘与土，八千里路云和月。莫等闲，白了少年头，空悲切！',
        '3靖康耻，犹未雪。臣子恨，何时灭！驾长车，踏破贺兰山缺。壮志饥餐胡虏肉，笑谈渴饮匈奴血。待从头、收拾旧山河，朝天阙。',
        '4丙辰中秋，欢饮达旦，大醉，作此篇，兼怀子由。明月几时有？把酒问青天。不知天上宫阙，今夕是何年。我欲乘风归去，又恐琼楼玉宇，高处不胜寒。起舞弄清影，何似在人间。转朱阁，低绮户，照无眠。不应有恨，何事长向别时圆？人有悲欢离合，月有阴晴圆缺，此事古难全。但愿人长久，千里共婵娟。',
        '5驿外断桥边，寂寞开无主。已是黄昏独自愁，更著风和雨。无意苦争春，一任群芳妒。零落成泥碾作尘，只有香如故。',
        '6我的好时机安居房快捷键萨克副教授看了附近时空大姐夫开始打积分卡仕达及啊看放假撒加分撒酒疯|打开积分看电视剧阿发空间的萨克福建省啦',
        '7明月几时有？把酒问青天。不知天上宫阙，今夕是何年。我欲乘风归去，又恐琼楼玉宇，高处不胜寒。起舞弄清影，何似在人间。转朱阁，低绮户，照无眠。不应有恨，何事长向别时圆？人有悲欢离合，月有阴晴圆缺，此事古难全。但愿人长久，千里共婵娟。',
        '8大江东去，浪淘尽，千古风流人物。故垒西边，人道是，三国周郎赤壁。乱石穿空，惊涛拍岸，卷起千堆雪。江山如画，一时多少豪杰。遥想公瑾当年，小乔初嫁了，雄姿英发。羽扇纶巾，谈笑间，樯橹灰飞烟灭。故国神游，多情应笑我，早生华发。人生如梦，一尊还酹江月。',
        '9春花秋月何时了？往事知多少。小楼昨夜又东风，故国不堪回首月明中。雕栏玉砌应犹在，只是朱颜改。问君能有几多愁？恰似一江春水向东流。',
        '10东风夜放花千树。更吹落、星如雨。宝马雕车香满路。凤箫声动，玉壶光转，一夜鱼龙舞。蛾儿雪柳黄金缕。笑语盈盈暗香去。众里寻他千百度。蓦然回首，那人却在，灯火阑珊处。',
        '我是中古的文字4']
      let messages2 = [
        '0驿外断桥边，寂寞开无主',
        'I am Chiniese',
        '1东风夜放花千树。更吹落、星如雨。宝马雕车香满路。',
        '2怒发冲冠，凭栏处、潇潇雨歇。抬望眼，仰天长啸，壮怀激烈。三十功名尘与土，八千里路云和月。莫等闲，白了少年头，空悲切！',
        '3明月别枝惊鹊，清风半夜鸣蝉',
        '4丙辰中秋，欢饮达旦，大醉，作此篇，兼怀子由',
        '5驿外断桥边，寂寞开无主。已是黄昏独自愁，更著风和雨。',
        '6我的好时机安居房快捷键萨克副教授看了附近时空大姐夫开',
        '7明月几时有？把酒问青天。不知天上宫阙，今夕是何年。我欲乘风归去，又恐琼楼玉宇，高处不胜寒。',
        '8大江东去，浪淘尽，千古风流人物。故垒西边，人道是，三国周郎赤壁。',
        '9春花秋月何时了？往事知多少。小楼昨夜又东风，故国不堪回首月明中。',
        '10东风夜放花千树。更吹落、星如雨。宝马雕车香满路。',
        '我是中古的文字4']
      ...
      switch (name) {
        ...
        case 'NewText':
          options = {
            ...
            visible: true,
            fontSize: 20,
            textdemo: messages2[i], // messages[i] |我的好时机安居房快捷键萨克副教授看了附近时空大姐夫开始打积分卡仕达及啊看放假撒加分撒酒疯|打开积分看电视剧阿发空间的萨克福建省啦
            originXY: ['right', 'bottom'],
    ...
    // 缩放比例
    changeBigZoom () {
      this.$refs.canvas.changeWH({width: 600, height: 600, backgroundColor: '#fff', backgroundImage: 'https://pre.zkong.com/group1/M00/05/7C/wKgAa2WnlOqAT4BBAA1Rx0gWfdg129.png'})
    },
    // 切换手和选择
    selectLi (no) {
      // console.log(no)
    ...
    // 保存数据
    save () {
      let json = this.$refs.canvas.toDatalessJSON()
      console.log(json)
